...
dataset = gnn.Make_graph_normal(root="../data_train_test_seprately/processed_normal")
with open("../data_train_test_seprately/processed_normal/dataset.pic", 'wb') as filehandle:
